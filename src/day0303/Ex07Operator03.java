...
public class Ex07Operator03 {
    public static void main(String[] args) {
        ...
        // 위 코드에서 사람이면 당연히 0 < number < 10 이 true가 나오는지 확인하겠지만 컴퓨터는 다음과 같이 시도한다.
        ...
        // 따라서, 우리가 값이 범위에 속하는지를 체크할려고 한다면, 다음에 배우게 될 논리 연산자를 사용해야한다!
        
         
         // 2. 변수와 변수가 아닌 값 자체를 비교할 때에는 
         //     변수를 왼쪽에 두는 것이 좀더 가독성이 좋다.
         
         // 3. 참조형 변수를 비교할 때에 비교 연산자를 사용하게 된다면 부정확한 결과값을 얻을 가능성이 매우 높다.

...
public class BoardEx01 {
    ...
    // 회원을 관리할 ArrayList<> 객체 userLidt;
    private final static ArrayList<User> userList = new ArrayList<>();
    // 게시글을 관리할 ArrayList<> 객체 boardLidt;
    ...
    private static void index() {
        while (true) {
            System.out.println("==============================");
            System.out.println("   비트 캠프 게시판 관리 프로그램    ");
            System.out.println("==============================");
            ...
            if (userChoice == 1) {
                ...
                if (userList.isEmpty()) {
                    ...
                    // 게시판 메뉴를 불러오는 showMunu() 메소드를 실행한다.
                    if (LogIn != null) {
                        showMenu();
                    }
                }
    ...
    private static void printAllBoard() {
        ...
        if (boardList.isEmpty()) {
            ...
            // 게시글의 작성일을 형식에 맞춰춘 simpleDateFormat 객체 생성
    ...
    private static void printOneBoard(int id) {
        ...
        if (b == null) {
            ...
            System.out.println("==========================");
            // 만약 댓글이 존재하지 않으면
            // "등록된 댓글이 존재하지 않습니다" 라는 메시지만 출력해주고 그외에는
    ...
    // 사용자가 넘겨준 id 값으로
    // replyList 중에 boardId 가 일치하는 Reply 객체들을
    ...
    private static void writeBoard() {
        ...
        // boardList 에 추가할 Board 의 임시 객체 b
        Board b = new Board();
    ...
    private static void register() {
        ...
        String message = new String("사용 하실 아이디를 입력해주세요.");

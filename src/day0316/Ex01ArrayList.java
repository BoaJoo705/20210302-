...
// List 를 상속받는 클래스 중 하나인 ArrayList이다.
...
public class Ex01ArrayList {
    public static void main(String[] args) {
        ...
        // 이번 예제에서 사용할 Student객체를 여러개 만들어보자
        ...
        System.out.println("list.get(0).getName(): "+list.get(0).getName());
        Student temp = list.set(0, s1);//변경
        System.out.println("list.get(0).getName(): "+list.get(0).getName());
        list.set(0, temp);//변경해주고 복구
        System.out.println("list.get(0).getName(): "+list.get(0).getName());
        System.out.println();
        ...
        System.out.println("B. euals()가 true가 나오는 객체를 사용하는 경우");
        ...
        //      만약 해당 객체와 equals(true)가 나오는 객체가 없을 때에는 아무것도 삭제되지 않지만

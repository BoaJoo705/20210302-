...
public class DogShelter {
    public static void main(String[] args) {
        ...
        while (true) {
            int userChoice = ScannerUtil.nextInt(scanner, "1. 잃어버린 개 등록 2. 일치하는 개 찾기 3. 주인 찾은 개 목록에서 삭제  4. 종료");
            if (userChoice == 1) {
                // 잃어버린 개를 리스트에 등록
                Dog d = new Dog();
                ...
                while(list.contains(d)) {
                    System.out.println("해당 번호는 이미 등록된 등록 번호입니다.");
                    d.setId(ScannerUtil.nextLine(scanner, message));
                }

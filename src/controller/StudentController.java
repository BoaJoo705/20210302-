...
// 우리는 데이터베이스가 없으므로
// 이 안에 ArrayList<>를 이용하여 유사 데이터베이스를 만들어 보게 될 것이다.
...
public class StudentController {
    ...
    // datebase의 기능을 하나 대신해줄 int 변수 id
    private int id;
    ...
    // 3. 파라미터로 넘어온 group 과 같은 group에 속하는 StudentDTO 객체를
    ...
    // 5. 사용자가 입력한 username과 같은 username 이 있으면
    // true 를 리턴하는 validateUsername() 메소드

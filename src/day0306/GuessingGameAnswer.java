...
public class GuessingGameAnswer {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println(); // 보기 쉽게 보이기 위해 빈공간둠
            ...
            if (userChoice == 1) {
                ...
                // 1. 컴퓨터 숫자 결정
                int computerNumber = random.nextInt(NUMBER_MAX) + 1;// System.out.println(random.nextInt(101));
                ...
                if (bestScore > 0) {
                    System.out.println();
                    System.out.printf("사용자의 최고기록: %3d회\n", bestScore);
                    System.out.println();
                } else {
                    System.out.println();

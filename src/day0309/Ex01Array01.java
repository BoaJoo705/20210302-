...
public class Ex01Array01 {
    public static void main(String[] args) {
        ...
        // 스택 영역에 메모리 값이 부여되어있지만, 힙 영역에 해당 공간은 초기화가 안되어 있는 상태를
        // null 이라고 한다.
        ...
        for (int i = 0; i < size; i++) {
            ...
            // 찾지 못하는 경우, -1을 나오게 해서, 그 엘리먼트는 해당 배열에 존재 하지 않는다 를 나타나게 할 수도 있다!

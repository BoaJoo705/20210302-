...
public class Ex01String {
    public static void main(String[] args) {
        ...
        System.out.println("3. endWith()");
        str1 = new String("abcDEF");
        System.out.println("str1.endWith(\"F\"): " + str1.endsWith("F"));
        System.out.println("str1.endWith(\"G\"): " + str1.endsWith("G"));
        System.out.println("str1.endWith(\"EF\"): " + str1.endsWith("EF"));
        System.out.println("str1.endWith(\"EG\"): " + str1.endsWith("EG"));
        System.out.println();
        ...
        // subString(int)는 해당 숫자 인덱스부터 끝까지, subString(int, int)는 해당 숫자부터 뒤의 숫자까지
        // 원본은 변하지 않는다.
        ...
        // 6. toLowerCase()
        // toLowerCase() 는 현재 문자열을 모두 소문자로 바꾼 문자열을 return 해 준다.
        // 원본은 변하지 않는다.
        ...
        // 7. toUpperCase()
        //      toUpperCase()는 현재문자열을 모두 대문자로 바꾼 문자열을 return() 해준다.
        //      원본은 변하지 않는다.
        ...
        // 8. trim()
        //      trim()은 앞이나 뒤에 있는 공백 문자를 모두 제거한 문자열을 return 해준다.

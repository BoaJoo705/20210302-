...
public class Ex02Calendar {
    public static void main(String[] args) {
        // 캘린터 객체의 초기화는
        // 우리가 생성자를 부르는 것이 아니라
        // 캘린터 클래스 안의 getInstance()라는 스태틱 메소드를 통해서 한다.
        ...
        // 그안에 우리가 직접
        // 어떤 형식으로 날짜를 포매팅 해줄지를 결정해 줄 수 있다.
        ...
        // 1. 1970년 01월 01일 0시 0분 부터 지금까지의 시간을 1/1000 초 단위로 구해서 직접 값을 넣는다. ->딱 봐도 하기 싫어짐
        ...
        try {
            ...
            System.out.println("해당 String 값은 변환할수 없습니다!!!");
        }
